...
This README documents the Clash target derived for YouTube.

This directory mirrors the direct upstream Clash target for YouTube.
...
- File: [YouTube.yaml](./YouTube.yaml)
- Primary variant: `yes`
- Usage note: # 🧸 YouTube
- Selected source family: `native`
- Upstream native target: `Clash`
...
- File: [YouTube_No_Resolve.yaml](./YouTube_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/YouTube/YouTube_No_Resolve.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/YouTube/YouTube_No_Resolve.yaml)
...
### Upstream Entry 2 (blackmatrix7 / YouTube_No_Resolve)
