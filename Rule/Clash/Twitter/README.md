...
This README documents the Clash target derived for Twitter.

This directory mirrors the direct upstream Clash target for Twitter.
...
- File: [Twitter.yaml](./Twitter.yaml)
- Primary variant: `yes`
- Usage note: # 🧸 Twitter
- Selected source family: `native`
- Upstream native target: `Clash`
...
- File: [Twitter_No_Resolve.yaml](./Twitter_No_Resolve.yaml)
- Primary variant: `no`
