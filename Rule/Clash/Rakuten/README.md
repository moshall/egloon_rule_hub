...
This README documents the Clash target derived for Rakuten.

This directory mirrors the direct upstream Clash target for Rakuten.
...
- File: [Rakuten.yaml](./Rakuten.yaml)
- Primary variant: `yes`
- Usage note: # 🧸 Rakuten
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/Rakuten.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/Rakuten.yaml)

### Rakuten_No_Resolve

- File: [Rakuten_No_Resolve.yaml](./Rakuten_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/Rakuten_No_Resolve.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/Rakuten_No_Resolve.yaml)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / Rakuten)

- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/Rakuten.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/Rakuten.yaml)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Rakuten/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / Rakuten_No_Resolve)
