...
This README documents the Clash target derived for Steam.

This directory mirrors the direct upstream Clash target for Steam.

This layout documents a direct upstream target.

- Selected source family: `native`
- Upstream native target: `Clash`
- Icon: [icon.png](./icon.png) ([upstream source](https://raw.githubusercontent.com/Keviin560/icon/main/src/Steam.png))

## Published Variants

### Steam

- File: [Steam.yaml](./Steam.yaml)
- Primary variant: `yes`
- Usage note: # 🧸 Steam
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/Steam.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/Steam.yaml)

### Steam_No_Resolve

- File: [Steam_No_Resolve.yaml](./Steam_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/Steam_No_Resolve.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/Steam_No_Resolve.yaml)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / Steam)

- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/Steam.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/Steam.yaml)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Steam/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / Steam_No_Resolve)
