...
This README documents the Clash target derived for Proxy.

This directory mirrors the direct upstream Clash target for Proxy.
...
- File: [Proxy.yaml](./Proxy.yaml)
- Primary variant: `yes`
- Usage note: # 🧸 Proxy
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy.yaml)

### Proxy_Classical

- File: [Proxy_Classical.yaml](./Proxy_Classical.yaml)
- Primary variant: `no`
- Usage note: Proxy_Classical.yaml，请使用 behavior: "classical"。
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_Classical.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_Classical.yaml)

### Proxy_Classical_No_Resolve

- File: [Proxy_Classical_No_Resolve.yaml](./Proxy_Classical_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_Classical_No_Resolve.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_Classical_No_Resolve.yaml)

### Proxy_Domain

- File: [Proxy_Domain.yaml](./Proxy_Domain.yaml)
- Primary variant: `no`
- Usage note: Proxy_Domain.yaml，请使用 behavior: "domain"。
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_Domain.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_Domain.yaml)

### Proxy_No_Resolve

- File: [Proxy_No_Resolve.yaml](./Proxy_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_No_Resolve.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy_No_Resolve.yaml)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / Proxy)

- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/Proxy.yaml)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Proxy/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / Proxy_Classical)
...
### Upstream Entry 3 (blackmatrix7 / Proxy_Classical_No_Resolve)
...
### Upstream Entry 4 (blackmatrix7 / Proxy_Domain)
...
### Upstream Entry 5 (blackmatrix7 / Proxy_No_Resolve)
