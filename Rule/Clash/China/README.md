...
This README documents the Clash target derived for China.

This directory mirrors the direct upstream Clash target for China.
...
- File: [China.yaml](./China.yaml)
- Primary variant: `yes`
- Usage note: # 🧸 China
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China.yaml)

### China_Classical

- File: [China_Classical.yaml](./China_Classical.yaml)
- Primary variant: `no`
- Usage note: China_Classical.yaml，请使用 behavior: "classical"。
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_Classical.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_Classical.yaml)

### China_Classical_No_Resolve

- File: [China_Classical_No_Resolve.yaml](./China_Classical_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_Classical_No_Resolve.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_Classical_No_Resolve.yaml)

### China_Domain

- File: [China_Domain.yaml](./China_Domain.yaml)
- Primary variant: `no`
- Usage note: China_Domain.yaml，请使用 behavior: "domain"。
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_Domain.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_Domain.yaml)

### China_No_Resolve

- File: [China_No_Resolve.yaml](./China_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_No_Resolve.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China_No_Resolve.yaml)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / China)

- Upstream native target: `Clash`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China.yaml](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/China.yaml)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/China/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / China_Classical)
...
### Upstream Entry 3 (blackmatrix7 / China_Classical_No_Resolve)
...
### Upstream Entry 4 (blackmatrix7 / China_Domain)
...
### Upstream Entry 5 (blackmatrix7 / China_No_Resolve)
