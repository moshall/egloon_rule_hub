# ChinaIPsBGP for Clash

This README documents the Clash target derived for ChinaIPsBGP.

This README is generated by egloon_rule_hub and is not a native upstream Clash artifact.

- Selected source family: `shadowrocket`
- Upstream native target: `Shadowrocket`
- Icon: unavailable (strict upstream match not found)
- Conversion path: `Shadowrocket -> Clash`
