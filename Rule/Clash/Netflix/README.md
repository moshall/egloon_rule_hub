...
This README documents the Clash target derived for Netflix.

This directory mirrors the direct upstream Clash target for Netflix.
...
- File: [Netflix.yaml](./Netflix.yaml)
- Primary variant: `yes`
- Usage note: # 🧸 Netflix
- Selected source family: `native`
- Upstream native target: `Clash`
...
- File: [Netflix_Classical.yaml](./Netflix_Classical.yaml)
- Primary variant: `no`
- Usage note: Netflix_Classical.yaml，请使用 behavior: "classical"。
- Selected source family: `native`
- Upstream native target: `Clash`
...
- File: [Netflix_Classical_No_Resolve.yaml](./Netflix_Classical_No_Resolve.yaml)
- Primary variant: `no`
...
- File: [Netflix_IP.yaml](./Netflix_IP.yaml)
- Primary variant: `no`
- Usage note: Netflix_IP.yaml，请使用 behavior: "ipcidr"。
- Selected source family: `native`
- Upstream native target: `Clash`
...
- File: [Netflix_No_Resolve.yaml](./Netflix_No_Resolve.yaml)
- Primary variant: `no`
- Usage note: Additional published variant for manual selection.
- Selected source family: `native`
- Upstream native target: `Clash`
