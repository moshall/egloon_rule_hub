# ChinaMedia for SingBox

This README documents the SingBox target derived for ChinaMedia.
...
- File: [ChinaMedia.json](./ChinaMedia.json)
- Primary variant: `yes`
...
- File: [ChinaMedia_Resolve.json](./ChinaMedia_Resolve.json)
- Primary variant: `no`
