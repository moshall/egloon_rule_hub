# Telegram for SingBox

This README documents the SingBox target derived for Telegram.
...
- File: [Telegram.json](./Telegram.json)
- Primary variant: `yes`
- Usage note: # 🧸 Telegram
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
...
- File: [Telegram_Resolve.json](./Telegram_Resolve.json)
- Primary variant: `no`
