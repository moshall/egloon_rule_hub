...
This README documents the SingBox target derived for Apple.
...
- File: [Apple_Domain.json](./Apple_Domain.json)
- Primary variant: `no`
...
- File: [Apple_Resolve.json](./Apple_Resolve.json)
- Primary variant: `no`
