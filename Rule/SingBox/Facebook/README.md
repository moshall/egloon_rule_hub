# Facebook for SingBox

This README documents the SingBox target derived for Facebook.
...
- File: [Facebook.json](./Facebook.json)
- Primary variant: `yes`
- Usage note: # 🧸 Facebook
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
...
- File: [Facebook_Resolve.json](./Facebook_Resolve.json)
- Primary variant: `no`
