# ChinaIPsBGP for SingBox

This README documents the SingBox target derived for ChinaIPsBGP.
...
- File: [ChinaIPsBGP.json](./ChinaIPsBGP.json)
- Primary variant: `yes`
...
- File: [ChinaIPsBGP_Resolve.json](./ChinaIPsBGP_Resolve.json)
- Primary variant: `no`
