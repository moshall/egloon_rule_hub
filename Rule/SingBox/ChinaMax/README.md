# ChinaMax for SingBox

This README documents the SingBox target derived for ChinaMax.
...
- File: [ChinaMax.json](./ChinaMax.json)
- Primary variant: `yes`
...
- File: [ChinaMax_Domain.json](./ChinaMax_Domain.json)
- Primary variant: `no`
...
- File: [ChinaMax_Resolve.json](./ChinaMax_Resolve.json)
- Primary variant: `no`
