...
This README documents the Loon target derived for ChinaMedia.

This directory mirrors the direct upstream Loon target for ChinaMedia.
...
- File: [ChinaMedia.lsr](./ChinaMedia.lsr)
- Primary variant: `yes`
- Usage note: # 🧸 ChinaMedia
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/ChinaMedia.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/ChinaMedia.list)

### ChinaMedia_Resolve

- File: [ChinaMedia_Resolve.lsr](./ChinaMedia_Resolve.lsr)
- Primary variant: `no`
- Usage note: ChinaMedia_Resolve.list与ChinaMedia.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/ChinaMedia_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/ChinaMedia_Resolve.list)
...
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/ChinaMedia.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/ChinaMedia.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMedia/README.md)
- Status: `ok`
