...
This README documents the Loon target derived for ChinaMax.

This directory mirrors the direct upstream Loon target for ChinaMax.
...
- File: [ChinaMax.lsr](./ChinaMax.lsr)
- Primary variant: `yes`
- Usage note: ChinaMax_Resolve.list与ChinaMax.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax.list)

### ChinaMax_Domain

- File: [ChinaMax_Domain.lsr](./ChinaMax_Domain.lsr)
- Primary variant: `no`
- Usage note: ChinaMax.list、ChinaMax_Domain.list 共同使用。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_Domain.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_Domain.list)

### ChinaMax_No_IPv6

- File: [ChinaMax_No_IPv6.lsr](./ChinaMax_No_IPv6.lsr)
- Primary variant: `no`
- Usage note: ChinaMax.list与ChinaMax_No_IPv6.list的区别仅在于后者不带IPv6类型的规则，适用纯IPv4网络。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_No_IPv6.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_No_IPv6.list)

### ChinaMax_No_IPv6_Resolve

- File: [ChinaMax_No_IPv6_Resolve.lsr](./ChinaMax_No_IPv6_Resolve.lsr)
- Primary variant: `no`
- Usage note: ChinaMax_Resolve.list与ChinaMax_No_IPv6_Resolve.list的区别仅在于后者不带IPv6类型的规则，且不带no-resolve，适用纯IPv4网络。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_No_IPv6_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_No_IPv6_Resolve.list)

### ChinaMax_Resolve

- File: [ChinaMax_Resolve.lsr](./ChinaMax_Resolve.lsr)
- Primary variant: `no`
- Usage note: ChinaMax_Resolve.list与ChinaMax.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax_Resolve.list)
...
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/ChinaMax.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/ChinaMax/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / ChinaMax_Domain)
...
### Upstream Entry 3 (blackmatrix7 / ChinaMax_No_IPv6)
...
### Upstream Entry 4 (blackmatrix7 / ChinaMax_No_IPv6_Resolve)
...
### Upstream Entry 5 (blackmatrix7 / ChinaMax_Resolve)
