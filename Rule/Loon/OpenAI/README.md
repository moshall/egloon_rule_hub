...
This README documents the Loon target derived for OpenAI.

This directory mirrors the direct upstream Loon target for OpenAI.
...
- File: [OpenAI.lsr](./OpenAI.lsr)
- Primary variant: `yes`
- Usage note: # 🧸 OpenAI
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/OpenAI.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/OpenAI.list)
...
- File: [OpenAI_Resolve.lsr](./OpenAI_Resolve.lsr)
- Primary variant: `no`
- Usage note: OpenAI_Resolve.list与OpenAI.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/OpenAI_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/OpenAI_Resolve.list)
- Rule file: [https://raw.githubusercontent.com/v2fly/domain-list-community/master/data/openai](https://raw.githubusercontent.com/v2fly/domain-list-community/master/data/openai)
...
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/OpenAI.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/OpenAI.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/OpenAI/README.md)
- Status: `ok`
