...
This README documents the Loon target derived for Twitch.

This directory mirrors the direct upstream Loon target for Twitch.
...
- File: [Twitch.lsr](./Twitch.lsr)
- Primary variant: `yes`
- Usage note: # 🧸 Twitch
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/Twitch.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/Twitch.list)

### Twitch_Resolve

- File: [Twitch_Resolve.lsr](./Twitch_Resolve.lsr)
- Primary variant: `no`
- Usage note: Twitch_Resolve.list与Twitch.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/Twitch_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/Twitch_Resolve.list)
...
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/Twitch.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/Twitch.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Twitch/README.md)
- Status: `ok`
