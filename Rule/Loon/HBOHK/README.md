...
This README documents the Loon target derived for HBOHK.

This directory mirrors the direct upstream Loon target for HBOHK.
...
- File: [HBOHK.lsr](./HBOHK.lsr)
- Primary variant: `yes`
- Usage note: HBOHK.list 单独使用。
- Selected source family: `native`
- Upstream native target: `Loon`
