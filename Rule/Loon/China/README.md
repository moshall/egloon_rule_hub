...
This README documents the Loon target derived for China.

This directory mirrors the direct upstream Loon target for China.
...
- File: [China.lsr](./China.lsr)
- Primary variant: `yes`
- Usage note: # 🧸 China
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China.list)

### China_Domain

- File: [China_Domain.lsr](./China_Domain.lsr)
- Primary variant: `no`
- Usage note: China.list、China_Domain.list 共同使用。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China_Domain.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China_Domain.list)

### China_Resolve

- File: [China_Resolve.lsr](./China_Resolve.lsr)
- Primary variant: `no`
- Usage note: China_Resolve.list与China.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
- Selected source family: `native`
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China_Resolve.list)
...
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/China.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/China/README.md)
- Status: `ok`
