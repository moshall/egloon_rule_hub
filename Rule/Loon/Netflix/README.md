...
This README documents the Loon target derived for Netflix.

This directory mirrors the direct upstream Loon target for Netflix.
...
- File: [Netflix_Resolve.lsr](./Netflix_Resolve.lsr)
- Primary variant: `no`
- Usage note: Netflix_Resolve.list与Netflix.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
- Selected source family: `native`
- Upstream native target: `Loon`
...
- Upstream native target: `Loon`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Netflix/Netflix.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Netflix/Netflix.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Netflix/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Loon/Netflix/README.md)
- Status: `ok`
