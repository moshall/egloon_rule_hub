# GoogleEarth for Loon

This README documents the Loon target derived for GoogleEarth.

This directory mirrors the direct upstream Loon target for GoogleEarth.
...
- File: [GoogleEarth.lsr](./GoogleEarth.lsr)
- Primary variant: `yes`
