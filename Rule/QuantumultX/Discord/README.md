# Discord for QuantumultX

This README documents the QuantumultX target derived for Discord.

This directory mirrors the direct upstream QuantumultX target for Discord.

This layout documents a direct upstream target.

- Selected source family: `native`
- Upstream native target: `QuantumultX`
...
- File: [Discord.list](./Discord.list)
- Primary variant: `yes`
- Usage note: # 🧸 Discord
- Selected source family: `native`
- Upstream native target: `QuantumultX`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/QuantumultX/Discord/Discord.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/QuantumultX/Discord/Discord.list)
...
- Upstream native target: `QuantumultX`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/QuantumultX/Discord/Discord.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/QuantumultX/Discord/Discord.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/QuantumultX/Discord/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/QuantumultX/Discord/README.md)
- Status: `ok`
