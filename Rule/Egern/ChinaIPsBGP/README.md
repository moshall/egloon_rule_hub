# ChinaIPsBGP for Egern

This README documents the Egern target derived for ChinaIPsBGP.
...
- File: [ChinaIPsBGP.yaml](./ChinaIPsBGP.yaml)
- Primary variant: `yes`
...
- File: [ChinaIPsBGP_Resolve.yaml](./ChinaIPsBGP_Resolve.yaml)
- Primary variant: `no`
