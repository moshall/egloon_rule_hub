# ClaudeExtended for Shadowrocket

This README documents the Shadowrocket target derived for ClaudeExtended.
...
- TXT source: [Source/TXT/ClaudeExtended.txt](../../../Source/TXT/ClaudeExtended.txt)
