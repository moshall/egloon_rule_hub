# GoogleExtended for Shadowrocket

This README documents the Shadowrocket target derived for GoogleExtended.
...
- TXT source: [Source/TXT/GoogleExtended.txt](../../../Source/TXT/GoogleExtended.txt)
