# ChinaMax for Shadowrocket

This README documents the Shadowrocket target derived for ChinaMax.

This directory mirrors the direct upstream Shadowrocket target for ChinaMax.
...
- File: [ChinaMax.list](./ChinaMax.list)
- Primary variant: `yes`
- Usage note: ChinaMax.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax.list)

### ChinaMax_Domain

- File: [ChinaMax_Domain.list](./ChinaMax_Domain.list)
- Primary variant: `no`
- Usage note: ChinaMax_Domain.list，请使用DOMAIN-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax_Domain.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax_Domain.list)

### ChinaMax_Resolve

- File: [ChinaMax_Resolve.list](./ChinaMax_Resolve.list)
- Primary variant: `no`
- Usage note: ChinaMax_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax_Resolve.list)
...
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/ChinaMax.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMax/README.md)
- Status: `ok`
...
### Upstream Entry 3 (blackmatrix7 / ChinaMax_Resolve)
