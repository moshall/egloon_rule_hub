# OpenAI for Shadowrocket

This README documents the Shadowrocket target derived for OpenAI.

This directory mirrors the direct upstream Shadowrocket target for OpenAI.
...
- Rule file: [https://raw.githubusercontent.com/v2fly/domain-list-community/master/data/openai](https://raw.githubusercontent.com/v2fly/domain-list-community/master/data/openai)

### OpenAI_Resolve

- File: [OpenAI_Resolve.list](./OpenAI_Resolve.list)
- Primary variant: `no`
...
### Upstream Entry 1 (v2fly_domain_list / OpenAI)
...
### Upstream Entry 2 (v2fly_domain_list / OpenAI_Resolve)
...
### Upstream Entry 3 (blackmatrix7 / OpenAI)
...
### Upstream Entry 4 (blackmatrix7 / OpenAI_Resolve)
