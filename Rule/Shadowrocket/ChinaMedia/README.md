# ChinaMedia for Shadowrocket

This README documents the Shadowrocket target derived for ChinaMedia.

This directory mirrors the direct upstream Shadowrocket target for ChinaMedia.
...
- File: [ChinaMedia.list](./ChinaMedia.list)
- Primary variant: `yes`
- Usage note: # 🧸 ChinaMedia
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/ChinaMedia.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/ChinaMedia.list)

### ChinaMedia_Resolve

- File: [ChinaMedia_Resolve.list](./ChinaMedia_Resolve.list)
- Primary variant: `no`
- Usage note: ChinaMedia_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/ChinaMedia_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/ChinaMedia_Resolve.list)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / ChinaMedia)

- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/ChinaMedia.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/ChinaMedia.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaMedia/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / ChinaMedia_Resolve)
