# YouTube for Shadowrocket

This README documents the Shadowrocket target derived for YouTube.

This directory mirrors the direct upstream Shadowrocket target for YouTube.
...
- File: [YouTube.list](./YouTube.list)
- Primary variant: `yes`
- Usage note: # 🧸 YouTube
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/YouTube.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/YouTube.list)

### YouTube_Resolve

- File: [YouTube_Resolve.list](./YouTube_Resolve.list)
- Primary variant: `no`
- Usage note: YouTube_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/YouTube_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/YouTube_Resolve.list)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / YouTube)

- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/YouTube.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/YouTube.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/YouTube/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / YouTube_Resolve)
