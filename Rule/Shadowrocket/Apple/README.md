# Apple for Shadowrocket

This README documents the Shadowrocket target derived for Apple.

This directory mirrors the direct upstream Shadowrocket target for Apple.
...
- File: [Apple.list](./Apple.list)
- Primary variant: `yes`
- Usage note: # 🧸 Apple
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple.list)

### Apple_Domain

- File: [Apple_Domain.list](./Apple_Domain.list)
- Primary variant: `no`
- Usage note: Apple_Domain.list，请使用DOMAIN-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple_Domain.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple_Domain.list)

### Apple_Resolve

- File: [Apple_Resolve.list](./Apple_Resolve.list)
- Primary variant: `no`
- Usage note: Apple_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple_Resolve.list)
...
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/Apple.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Apple/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / Apple_Domain)
...
### Upstream Entry 3 (blackmatrix7 / Apple_Resolve)
