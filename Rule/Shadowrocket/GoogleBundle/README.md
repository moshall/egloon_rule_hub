# GoogleBundle for Shadowrocket

This README documents the merged Shadowrocket bundle artifact for GoogleBundle.

- Bundle file: [GoogleBundle.list](./GoogleBundle.list)
- Merge strategy: normalized and deduplicated merge of primary published variants only

## Included Services

- Google (primary variant: `Google`) - [README](../Google/README.md). Additional manual variants remain available: `Google_Resolve`
