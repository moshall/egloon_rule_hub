# AppleIntelligence for Shadowrocket

This README documents the Shadowrocket target derived for AppleIntelligence.
...
- TXT source: [Source/TXT/AppleIntelligence.txt](../../../Source/TXT/AppleIntelligence.txt)
