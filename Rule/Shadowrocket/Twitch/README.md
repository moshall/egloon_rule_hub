# Twitch for Shadowrocket

This README documents the Shadowrocket target derived for Twitch.

This directory mirrors the direct upstream Shadowrocket target for Twitch.
...
- File: [Twitch.list](./Twitch.list)
- Primary variant: `yes`
- Usage note: # 🧸 Twitch
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/Twitch.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/Twitch.list)

### Twitch_Resolve

- File: [Twitch_Resolve.list](./Twitch_Resolve.list)
- Primary variant: `no`
- Usage note: Twitch_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/Twitch_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/Twitch_Resolve.list)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / Twitch)

- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/Twitch.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/Twitch.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitch/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / Twitch_Resolve)
