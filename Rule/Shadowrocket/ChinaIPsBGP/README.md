# ChinaIPsBGP for Shadowrocket

This README documents the Shadowrocket target derived for ChinaIPsBGP.

This directory mirrors the direct upstream Shadowrocket target for ChinaIPsBGP.
...
- File: [ChinaIPsBGP.list](./ChinaIPsBGP.list)
- Primary variant: `yes`
- Usage note: # 🧸 ChinaIPsBGP
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/ChinaIPsBGP.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/ChinaIPsBGP.list)

### ChinaIPsBGP_Resolve

- File: [ChinaIPsBGP_Resolve.list](./ChinaIPsBGP_Resolve.list)
- Primary variant: `no`
- Usage note: ChinaIPsBGP_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/ChinaIPsBGP_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/ChinaIPsBGP_Resolve.list)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / ChinaIPsBGP)

- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/ChinaIPsBGP.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/ChinaIPsBGP.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/ChinaIPsBGP/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / ChinaIPsBGP_Resolve)
