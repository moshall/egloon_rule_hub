# Twitter for Shadowrocket

This README documents the Shadowrocket target derived for Twitter.

This directory mirrors the direct upstream Shadowrocket target for Twitter.
...
- File: [Twitter.list](./Twitter.list)
- Primary variant: `yes`
- Usage note: # 🧸 Twitter
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
...
- File: [Twitter_Resolve.list](./Twitter_Resolve.list)
- Primary variant: `no`
- Usage note: Twitter_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
...
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitter/Twitter.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitter/Twitter.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitter/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Twitter/README.md)
- Status: `ok`
