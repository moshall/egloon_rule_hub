# Spotify for Shadowrocket

This README documents the Shadowrocket target derived for Spotify.

This directory mirrors the direct upstream Shadowrocket target for Spotify.

This layout documents a direct upstream target.

- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Icon: [icon.png](./icon.png) ([upstream source](https://raw.githubusercontent.com/Keviin560/icon/main/src/Spotify.png))

## Published Variants

### Spotify

- File: [Spotify.list](./Spotify.list)
- Primary variant: `yes`
- Usage note: # 🧸 Spotify
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/Spotify.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/Spotify.list)

### Spotify_Resolve

- File: [Spotify_Resolve.list](./Spotify_Resolve.list)
- Primary variant: `no`
- Usage note: Spotify_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/Spotify_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/Spotify_Resolve.list)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / Spotify)

- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/Spotify.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/Spotify.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Spotify/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / Spotify_Resolve)
