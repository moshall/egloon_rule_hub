# Google for Shadowrocket

This README documents the Shadowrocket target derived for Google.

This directory mirrors the direct upstream Shadowrocket target for Google.
...
- File: [Google.list](./Google.list)
- Primary variant: `yes`
- Usage note: # 🧸 Google
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/Google.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/Google.list)

### Google_Resolve

- File: [Google_Resolve.list](./Google_Resolve.list)
- Primary variant: `no`
- Usage note: Google_Resolve.list，请使用RULE-SET。
- Selected source family: `native`
- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/Google_Resolve.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/Google_Resolve.list)

## Upstream README Sources

### Upstream Entry 1 (blackmatrix7 / Google)

- Upstream native target: `Shadowrocket`
- Rule file: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/Google.list](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/Google.list)
- README: [https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/README.md](https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Google/README.md)
- Status: `ok`
...
### Upstream Entry 2 (blackmatrix7 / Google_Resolve)
